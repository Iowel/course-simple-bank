...
import (
	...
	mockwk "github.com/Iowel/course-simple-bank/worker/mock"
...
func TestCreateUserAPI(t *testing.T) {
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			// Создание мокового объекта базы данных
			...
			tc.buildStubs(store, taskDistributor) // Настройка его поведения (например, какие данные он должен вернуть)
	...
	// Добавить тесткейсы когда имя пользователя уже существует или когда входные данные неверны
}
