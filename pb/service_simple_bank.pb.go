...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x15rpc_update_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xce\x03\n" +
	"\n" +
	...
	"Login user\x1a?Use this API to login user and get access token & refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB~\x92AS\x12Q\n" +
	"\x0fSimple Bank API\"9\n" +
	"\vTech School\x12\x18https://github.com/Iowel\x1a\x10none@example.com2\x031.2Z&github.com/Iowel/course-simple-bank/pbb\x06proto3"
